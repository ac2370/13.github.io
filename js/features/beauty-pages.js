// beauty-pages.js - 全局美化页面（点击自定义 + 设置联动）
(function() {
    'use strict';
    ...
    function createBeautyPage(index) {
        ...
        avatarWrap.style.cssText = 'text-align:center;margin-bottom:12px;cursor:pointer;';
    ...
    console.log('[美化页面] 模块已加载（点击自定义 + 设置联动）');
})();
