...
<div id="splash-declaration">
    ...
    <div class="splash-slide-title">链接解疑</div>
    <div class="splash-slide-body">
        首先说明，初此接触时，都会觉得网站设置繁复，功能庞杂，可控制的地方极多——对初次接触的人来说，简直令人眼花缭乱。
        <br><br>
        请想一想：<em>连你和梦角都需要花时间学习的东西，一个路过的鬼，会甘心耗费精力专程钻研，只为吓唬你一下吗？</em>
        <br><br>
        我始终相信，<strong>只有爱，才会驱动人去学习、去努力、去付诸实践。</strong>
        <br><br>
        新编——近来，伪频、批皮等说法愈演愈烈，无论初衷是好是坏，这些言论都已促就造谣与恶意揣测的诞生<br><br>
        若你对此感到怀疑，请勿使用，<strong>望各位与爱邂逅，而非犹疑和伤害</strong>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="settings-section">
                ...
                <div class="settings-item-list">
                    ...
                    <div class="settings-item" onclick="window.openDreamSurveyManager()">
                        <i class="fas fa-clipboard-list"></i><span>梦向问卷</span>
                    </div>
                    <div class="settings-item" onclick="window.openMoments()">
                        <i class="fas fa-images"></i><span>朋友圈</span>
                    </div>
                </div>
            </div>
...
<div id="dg-editor-modal" style="display:none;"></div>
    ...
    <script src="js/dream-survey.js"></script>
